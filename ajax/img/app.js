...
$(".btn").click(() => {
    $("#pie").append('<div id="caja">Llevá tu pasión por el Rojo a todas partes. Los modelos ideales para los más fanáticos.Hecha para que entrenes al máximo defendiendo los colores que han caracterizado al club y la importante gesta de títulos, entre ellas sus 7 Libertadores, en un fútbol que mezcló el buen pie con el compromiso, la actitud y la intensidad.<br/>Ponetela, cerrá los ojos e imaginate que estás frente a una multitud enfervorecida en el estadio Libertadores de América.</div>');

$("#caja").css({"font-size": "150%", "color": "red", display:''})
.slideDown(3000)  
.delay(2000)     
.slideUp(3000);
